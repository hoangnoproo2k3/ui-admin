...
const CustomModal = ({ size, isOpen, onClose, selectedUserId }: any) => {
    return (
        <Modal size={size} isOpen={isOpen} onClose={onClose} className="dark:bg-[#1b2559]">
            <ModalContent>
                <>
                    <ModalHeader className="mt-6 flex flex-col gap-1">Modal Title {selectedUserId ? selectedUserId : ''}</ModalHeader>
                    <ModalBody>
